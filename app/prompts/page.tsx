  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Dialog open={runDialogOpen} onOpenChange={setRunDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[80vw] lg:max-w-[66vw]">
          <DialogHeader>
      ...
      <Dialog open={versionsDialogOpen} onOpenChange={setVersionsDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[80vw] lg:max-w-[66vw] max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
      ...
      <Dialog open={outputsDialogOpen} onOpenChange={setOutputsDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[80vw] lg:max-w-[66vw] max-h-[95vh] overflow-hidden flex flex-col">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
